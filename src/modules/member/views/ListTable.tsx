    ...
    const columns = computed<MColumns<ListItem>[]>(() => {
      ...
      const cols: MColumns<ListItem>[] = [
        ...
        },
        {
          ...
          dataIndex: 'role',
          width: '10%',
          customRender: ({value}) => DRole.valueToLabel[value],
        },
        {
          title: '性别',
          dataIndex: 'gender',
          align: 'center',
          width: '100px',
          customRender: ({value}) => DGender.valueToLabel[value],
        },
        {
          title: '文章数',
          dataIndex: 'articles',
        ...
        },
        {
          ...
          dataIndex: 'status',
          width: '100px',
          customRender: ({value}) => <span class={`g-${value}`}>{DStatus.valueToLabel[value]}</span>,
        },
      ];
      if (actionColumns) {
